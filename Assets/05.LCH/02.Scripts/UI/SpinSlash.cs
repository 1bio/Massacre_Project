...
public class SpinSlash : MonoBehaviour
{
    ...
    private void UpdateUI()
    {
        ...
        spinSlashTexts[4].text = $"공격력 {Mathf.Floor((spinSlash.multipleDamage - 1) * 100)}% 증가"; // 공격력 증가율 
        spinSlashTexts[5].text = $"쿨타임 {Mathf.Floor((spinSlash.multipleCoolDown - 1) * 100)}% 감소"; // 쿨타임 감소율
    }
    #endregion
}
