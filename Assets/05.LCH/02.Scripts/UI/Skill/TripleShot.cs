...
public class TripleShot : MonoBehaviour
{
    ...
    private void UpdateUI()
    {
        ...
        tripleShotTexts[4].text = $"공격력 {Mathf.Floor((tripleShot.multipleDamage - 1) * 100)}% 증가"; // 공격력 증가율 
        tripleShotTexts[5].text = $"쿨타임 {Mathf.Floor((tripleShot.multipleCoolDown - 1) * 100)}% 감소"; // 쿨타임 감소율
    }
    #endregion
}
