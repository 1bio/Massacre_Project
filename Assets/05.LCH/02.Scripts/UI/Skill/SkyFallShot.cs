...
public class SkyFallShot : MonoBehaviour
{
    ...
    private void UpdateUI()
    {
        ...
        skyfallShotTexts[4].text = $"공격력 {Mathf.Floor((skyfallShot.multipleDamage - 1) * 100)}% 증가"; // 공격력 증가율 
        skyfallShotTexts[5].text = $"쿨타임 {Mathf.Floor((skyfallShot.multipleCoolDown - 1) * 100)}% 감소"; // 쿨타임 감소율
    }
    #endregion
}
