...
public class FireBlade : MonoBehaviour
{
    ...
    private void UpdateUI()
    {
        ...
        fireBladeTexts[4].text = $"공격력 {Mathf.Floor((fireBlade.multipleDamage - 1) * 100)}% 증가"; // 공격력 증가율 
        fireBladeTexts[5].text = $"쿨타임 {Mathf.Floor((fireBlade.multipleCoolDown - 1) * 100)}% 감소"; // 쿨타임 감소율
    }
    #endregion
}
