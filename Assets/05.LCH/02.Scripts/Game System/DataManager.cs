...
public class DataManager : MonoBehaviour
{
    ...
    private void Initialized()
    {
        ...
        skillData = new List<SkillData>
        {
            ...
            new SkillData("화염칼", 0, 0f, 20f, 20f, 0.35f, true, "10초동안 근거리 무기를 \r\n불로 강화하여 공격합니다", 1.05f, 0.95f), // 스킬 1 [4]
            new SkillData("회전베기", 0, 20f, 6f, 0.005f, 0.35f, true, "1초동안 회전하며 \r\n강력한 힘을 방출합니다", 1.05f, 0.9f), // 스킬 3 [5]
        };
        
        attackData = new List<AttackData>()
        {
            new AttackData("Attack1@Melee", 1, 0.6f, 0.1f, 0.5f, 0.05f, 10f, 0f), // 근거리 공격 1
            new AttackData("Attack2@Melee", 2, 0.5f, 0.1f, 0.5f, 0.05f, 10f, 0f), // 근거리 공격 2
            new AttackData("Attack3@Melee", -1, 0, 0.1f, 0.65f, 0.05f, 20f, 0f), // 근거리 공격 3

            new AttackData("HeavyAttack1@Melee", 4, 0.6f, 0.1f, 0.05f, 0.35f, 20f, 0f), // 근거리 패시브 공격 1
            new AttackData("HeavyAttack2@Melee", 5, 0.5f, 0.1f, 0.05f, 0.35f, 20f, 0f), // 근거리 패시브 공격 2
            new AttackData("HeavyAttack3@Melee", -1, 0, 0.1f, 0.05f, 0.35f, 35f, 0f) // 근거리 패시브 공격 3
        };
