...
public class PlayerLightImpactState : PlayerBaseState
{
    ...
    public PlayerLightImpactState(PlayerStateMachine stateMachine) : base(stateMachine)
    {
    }
    ...
    public override void Tick(float deltaTime)
    {
        ...
        // 두 대 연속으로 피격 당할 경우
        if (stateMachine.Health.hitCount == 2)
        {
            stateMachine.ChangeState(new PlayerMediumImpactState(stateMachine));
            return;
        }
    }
